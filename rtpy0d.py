...
def   fmt_inject  ( desc , indent ):
    return    str ("\n") +   str ( indent ) +   str ("⟹  ") +   str ( desc  [" component "]. name ) +   str (".") +   str ( desc  [" port "]) +  format_message  ( desc  [" message "])      
...
def   fmt_inout  ( desc , indent ):
    ...
    if    None  ==  outm :
        ...
        return    str ("\n") +   str ( indent ) +   str ("  ∴ ") +   str ( desc  [" component "]. name ) +  format_message  ( outm )    
...
def   injector_NIY  ( eh , msg ):
    print
    str ("Injector not implemented for this component `") +   str ( eh . name ) +   str ("` kind ∷ ") +   str ( eh . kind ) +   str ("`port ∷ `") +   str ( msg . port ) + "`"
    exit  ()
